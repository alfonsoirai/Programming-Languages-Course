...
% Calculate maximazes, o max, x min
...
% Human player is x.
% Adapted from https://www.cpp.edu/~jrfisher/www/prolog_tutorial/8_4.html.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
